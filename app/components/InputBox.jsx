        ...
        return (
            <div className="col-m-6 col-4">
                <div style={{backgroundColor: "#fff", height: "140px", margin: "10px", borderRadius: "6px"}} >
                    <div style={{padding: "20px 0 20px 20px", fontFamily: "Verdana"}}>Syncs in realtime across clients</div>                    
                    ...
                    <div style={{padding: "10px 0 0 20px", fontFamily: "Verdana", color: "#f00"}}>{this.state.status}</div>                
                    <div style={{padding: "0 0 0 20px", fontFamily: "Verdana", color: "#f00"}}>{this.props.addErr}</div>
                </div>
            </div>
        );
    }
